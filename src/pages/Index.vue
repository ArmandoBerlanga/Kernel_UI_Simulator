...
<q-page class="container">
    ...
    <div class="sec procesos">
        ...
        <div class="content">
            <Procesos :procesos="state.procesos" @procesoNuevo="addProceso" />
        </div>
    </div>
    ...
    <div class="sec cpu">
        ...
        <div class="content">
            <CPU :algoritmos="algoritmos" :quantum="state.tamQuantum" @guardar="updateCPU" />
        </div>
    </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        function updateCPU(res) {
            state.algoritmo = res.algoritmo;
            state.tamQuantum = res.quantum;
        }

        function addProceso(res) {
            // console.log(res);
            res.tiempoLlegada = state.relojInterno;
            state.procesos.push(res);
